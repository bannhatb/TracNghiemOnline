...
@Component({
  selector: 'app-analysis-test',
  templateUrl: './analysis-test.component.html',
  styleUrls: ['./analysis-test.component.scss']
})
export class AnalysisTestComponent implements OnInit {
